...
if ( ! function_exists( 'starter_s_woocommerce_product_columns_wrapper_close' ) ) {
	/**
	 * Product columns wrapper close.
	 *
	 * @return  void
	 */
	function starter_s_woocommerce_product_columns_wrapper_close() {
		echo '</div>';
	}
}
add_action( 'woocommerce_after_shop_loop', 'starter_s_woocommerce_product_columns_wrapper_close', 40 );
...
if ( ! function_exists( 'starter_s_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
...
add_action( 'woocommerce_before_main_content', 'starter_s_woocommerce_wrapper_before' );

if ( ! function_exists( 'starter_s_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
...
add_action( 'woocommerce_after_main_content', 'starter_s_woocommerce_wrapper_after' );
...
if ( ! function_exists( 'starter_s_woocommerce_cart_link_fragment' ) ) {
	...
	function starter_s_woocommerce_cart_link_fragment( $fragments ) {
		ob_start();
		starter_s_woocommerce_cart_link();
...
if ( ! function_exists( 'starter_s_woocommerce_cart_link' ) ) {
	/**
	 * Cart Link.
	 *
...
if ( ! function_exists( 'starter_s_woocommerce_header_cart' ) ) {
	 ...
	 * @return void
	 */
	function starter_s_woocommerce_header_cart() {
		if ( is_cart() ) {
